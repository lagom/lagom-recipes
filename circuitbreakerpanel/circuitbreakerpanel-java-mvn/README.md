...
In this sample we use the circuitBreakerPanel in [`DemoServceimpl`](circuitbreakerpanel-java-mvn/circuitbreakerpanel-impl/src/main/java/com/lightbend/lagom/recipes/cbpanel/impl/DemoServiceImpl.java)
