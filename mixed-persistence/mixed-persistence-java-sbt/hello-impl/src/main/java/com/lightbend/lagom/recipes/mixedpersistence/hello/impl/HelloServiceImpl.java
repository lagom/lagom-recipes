...
import com.lightbend.lagom.recipes.mixedpersistence.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<com.lightbend.lagom.recipes.mixedpersistence.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      persistentEntityRegistry.eventStream(tag, offset).map(eventAndOffset -> {
        ...
        com.lightbend.lagom.recipes.mixedpersistence.hello.api.HelloEvent eventToPublish;
        ...
        if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
          ...
          eventToPublish = new com.lightbend.lagom.recipes.mixedpersistence.hello.api.HelloEvent.GreetingMessageChanged(
